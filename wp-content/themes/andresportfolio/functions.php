...
function red_starter_scripts() {
	...
	wp_enqueue_style( 'red-starter-font-awesome', get_template_directory_uri() . '/font-awesome/css/font-awesome.min.css' );


	wp_enqueue_script( 'red-starter-skip-link-focus-fix', get_template_directory_uri() . '/build/js/skip-link-focus-fix.min.js', array(), '20130115', true );

	wp_enqueue_script( 'appear-script', get_template_directory_uri() . '/build/js/jquery.appear.min.js',array( 'jquery' ),true);
